	...
	actions: {
		...
		placeOrder: function() {
			if (this.validateInformation()) {
				...
				order.set('cardName', this.get('cardName'))
					 .set('cardNumber', this.get('cardNumber'))
					 .set('street', this.get('street'))
					 .set('city', this.get('city'))
					 .set('zipcode', this.get('zipcode'))
					 .set('phoneNumber', this.get('phone'))
					 .set('deliveryTime', this.get('selectedTime'))
					 .set('amount', this.get('totalAmount'))
					 .set('tax', this.get('tax'))
					 .set('totalAmount', this.get('total'))
					 .set('date', new Date());
				...
				this.set('cardName', '')
					...
					.set('phone', '')
					.set('selectedTime', '')
					.set('isShowingError', false)
					.set('isShowingPayment', false)
					.set('isShowingAddress', false);
				this.clearCart();
