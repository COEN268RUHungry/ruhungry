...
export var MAP_TYPES = Ember.A([obj({ id: "road", label: "road" }), obj({ id: "satellite", label: "satellite" }), obj({ id: "terrain", label: "terrain" }), obj({ id: "hybrid", label: "hybrid" })]);

export var PLACE_TYPES = Ember.A([obj({ id: helpers.PLACE_TYPE_ADDRESS, label: "address" }), obj({ id: helpers.PLACE_TYPE_LOCALITY, label: "locality" }), obj({ id: helpers.PLACE_TYPE_ADMIN_REGION, label: "administrative region" }), obj({ id: helpers.PLACE_TYPE_BUSINESS, label: "business" })]);
